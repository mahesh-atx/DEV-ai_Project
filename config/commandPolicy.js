...
export const DEFAULT_COMMAND_POLICY = {
  ...
  commandLogFile: ".devai_command_log.jsonl",
  policyFileName: ".devai_policy.json",
  allowedScripts: {
    npm: ["build", "lint", "test", "start", "dev", "devai", "chat"],
    pnpm: ["build", "lint", "test", "start", "dev", "devai", "chat"],
    yarn: ["build", "lint", "test", "start", "dev", "devai", "chat"],
  },
  allowedNodeScripts: ["devai.js", "chat.js", "test_all.js", "test_context_budget.js"],
